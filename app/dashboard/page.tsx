...
import { FileText, Mail, Clock, Crown, Plus } from 'lucide-react';
                    ...
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-2 mt-2">
                          <Badge variant={doc.type === 'cover_letter' ? 'default' : 'secondary'}>
                            {doc.type === 'cover_letter' ? 'Cover Letter' : 'Cold Email'}
                          </Badge>
